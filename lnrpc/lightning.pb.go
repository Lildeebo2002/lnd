...
var file_lightning_proto_rawDesc = []byte{
	...
	0x45, 0x50, 0x54, 0x45, 0x44, 0x10, 0x03, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0x9d, 0x05,
	...
	0x63, 0x2e, 0x41, 0x4d, 0x50, 0x52, 0x03, 0x61, 0x6d, 0x70, 0x12, 0x59, 0x0a, 0x13, 0x77, 0x69,
	0x72, 0x65, 0x5f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e,
	0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x48, 0x54, 0x4c, 0x43, 0x2e, 0x57, 0x69, 0x72, 0x65,
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x45, 0x6e, 0x74,
	0x72, 0x79, 0x52, 0x11, 0x77, 0x69, 0x72, 0x65, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x52, 0x65,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x44, 0x0a, 0x16, 0x57, 0x69, 0x72, 0x65, 0x43,
...
var file_lightning_proto_depIdxs = []int32{
	...
	152, // 145: lnrpc.PayReq.blinded_paths:type_name -> lnrpc.BlindedPaymentPath
	180, // 146: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	38,  // 147: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	182, // 148: lnrpc.PolicyUpdateRequest.inbound_fee:type_name -> lnrpc.InboundFee
	39,  // 149: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	11,  // 150: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	184, // 151: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	187, // 152: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	38,  // 153: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	38,  // 154: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	38,  // 155: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	194, // 156: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	191, // 157: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	190, // 158: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	194, // 159: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	199, // 160: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	199, // 161: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	247, // 162: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	20,  // 163: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	210, // 164: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	212, // 165: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	199, // 166: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	216, // 167: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	217, // 168: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	217, // 169: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	219, // 170: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	220, // 171: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	178, // 172: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	178, // 173: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	4,   // 174: lnrpc.PendingChannelsResponse.PendingChannel.initiator:type_name -> lnrpc.Initiator
	3,   // 175: lnrpc.PendingChannelsResponse.PendingChannel.commitment_type:type_name -> lnrpc.CommitmentType
	227, // 176: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	227, // 177: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	230, // 178: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	227, // 179: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	227, // 180: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	109, // 181: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	15,  // 182: lnrpc.PendingChannelsResponse.ForceClosedChannel.anchor:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel.AnchorState
	114, // 183: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	178, // 184: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	138, // 185: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	178, // 186: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	178, // 187: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	155, // 188: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	178, // 189: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	206, // 190: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	115, // 191: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	118, // 192: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	30,  // 193: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	42,  // 194: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	46,  // 195: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	48,  // 196: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	30,  // 197: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	44,  // 198: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	50,  // 199: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	52,  // 200: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	54,  // 201: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	56,  // 202: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	58,  // 203: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	74,  // 204: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	76,  // 205: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	78,  // 206: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	80,  // 207: lnrpc.Lightning.GetDebugInfo:input_type -> lnrpc.GetDebugInfoRequest
	82,  // 208: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	110, // 209: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	63,  // 210: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	112, // 211: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	70,  // 212: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	97,  // 213: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	97,  // 214: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	94,  // 215: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	107, // 216: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	37,  // 217: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	89,  // 218: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	172, // 219: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	...
	156, // 224: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	161, // 225: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	160, // 226: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	163, // 227: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	176, // 228: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	166, // 229: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	168, // 230: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	169, // 231: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	134, // 232: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	136, // 233: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	139, // 234: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	...
	140, // 237: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	142, // 238: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	144, // 239: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	174, // 240: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	179, // 241: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	183, // 242: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	186, // 243: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	189, // 244: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	192, // 245: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	193, // 246: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	195, // 247: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	197, // 248: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	200, // 249: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	202, // 250: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	204, // 251: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	207, // 252: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	213, // 253: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	218, // 254: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	...
	116, // 259: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	119, // 260: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	...
	77,  // 273: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	79,  // 274: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	81,  // 275: lnrpc.Lightning.GetDebugInfo:output_type -> lnrpc.GetDebugInfoResponse
	83,  // 276: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	111, // 277: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	64,  // 278: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	113, // 279: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	71,  // 280: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	38,  // 281: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	98,  // 282: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	96,  // 283: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	108, // 284: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	36,  // 285: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	90,  // 286: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	173, // 287: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	34,  // 288: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	34,  // 289: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	34,  // 290: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	34,  // 291: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	159, // 292: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	162, // 293: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	156, // 294: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	156, // 295: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	177, // 296: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	167, // 297: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	170, // 298: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	171, // 299: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	135, // 300: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	137, // 301: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	133, // 302: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	129, // 303: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	123, // 304: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	141, // 305: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	143, // 306: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	145, // 307: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	175, // 308: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	181, // 309: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	185, // 310: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	188, // 311: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	190, // 312: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	193, // 313: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	198, // 314: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	196, // 315: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	193, // 316: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	201, // 317: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	203, // 318: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	205, // 319: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	208, // 320: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	214, // 321: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	215, // 322: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	26,  // 323: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	24,  // 324: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
	67,  // 325: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	22,  // 326: lnrpc.Lightning.LookupHtlcResolution:output_type -> lnrpc.LookupHtlcResolutionResponse
	259, // [259:327] is the sub-list for method output_type
	191, // [191:259] is the sub-list for method input_type
